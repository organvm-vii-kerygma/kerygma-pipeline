...
**Org:** `organvm-vii-kerygma` | **Repo:** `kerygma-pipeline`

### Edges
- **Produces** → `ORGAN-IV`: distribution_event
- **Consumes** ← `announcement-templates`: template_registry
- **Consumes** ← `social-automation`: social_config
- **Consumes** ← `distribution-strategy`: distribution_strategy
- **Consumes** ← `ORGAN-I`: research-publication
- **Consumes** ← `ORGAN-II`: creative-release
- **Consumes** ← `ORGAN-VI`: community-announcement
- **Consumes** ← `ORGAN-III`: client-launch

### Siblings in Marketing
`announcement-templates`, `social-automation`, `distribution-strategy`, `.github`, `kerygma-profiles`
...
Run: `organvm ecosystem show kerygma-pipeline` | `organvm ecosystem validate --organ VII`
...
Convergences: 20 | Run: `organvm network map --repo kerygma-pipeline` | `organvm network suggest`
